...
function Contact() {
  ...
  const handleChange = (e) => {
    ...
    // Preserve original casing for email; capitalize text fields automatically
    const formattedValue = name === "email"? value: value.toLowerCase().replace(/\b\w/g, (c) => c.toUpperCase());
